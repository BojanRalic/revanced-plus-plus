...
import app.revanced.patches.youtube.misc.playservice.is2034OrGreater
import app.revanced.patches.youtube.misc.playservice.is2102OrGreater
...
val seekbarColorPatch = bytecodePatch(
    ...
    apply {
        ...
        val playerMatch = playerLinearGradientMethodMatch
        val checkGradientCoordinates = true
        ...
        lottieAnimationViewSetAnimationIntMethod.classDef.methods.apply {
            ...
            add(
                ImmutableMethod(
                    ...
                    val methodOpcode = if (is2102OrGreater) "invoke-direct" else "invoke-virtual"
