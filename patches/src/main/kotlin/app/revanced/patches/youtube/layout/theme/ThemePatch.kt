...
import app.revanced.patches.youtube.misc.playservice.is2106OrGreater
    ...
    block = {
        ...
        dependsOn(
            ...
            baseThemeResourcePatch(
                ...
                getDarkColorNames = {
                    THEME_DEFAULT_DARK_COLOR_NAMES + if (is2106OrGreater)
                        setOf(
                ...
                getLightColorNames = {
                    THEME_DEFAULT_LIGHT_COLOR_NAMES + if (is2106OrGreater)
                        setOf(
