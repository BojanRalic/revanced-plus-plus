...
import app.revanced.patches.youtube.misc.playservice.is2019OrGreater
import app.revanced.patches.youtube.misc.playservice.is2020OrGreater
import app.revanced.patches.youtube.misc.playservice.is2049OrGreater
...
val videoInformationPatch = bytecodePatch(
    ...
    apply {
        ...
        (if (is2019OrGreater) videoQualityMethod else videoQualityLegacyMethod).apply {
            videoQualityClassType = immutableClassDef.type

            // Fix bad data used by YouTube.
            val nameRegister = if (is2020OrGreater) "p3" else "p2"
            addInstructions(
                0,
                """
